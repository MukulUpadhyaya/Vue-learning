<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control">
      ...
      <div>
        <input id="interest-news" name="interest" v-model="interest" type="checkbox" value="News" />
        <label for="interest-news">News</label>
      </div>
      <div>
        <input id="interest-tutorials" name="interest" v-model="interest" type="checkbox" value="Tutorials" />
        <label for="interest-tutorials">Tutorials</label>
      </div>
      <div>
        <input id="interest-nothing" name="interest" v-model="interest" type="checkbox" value="Nothing" />
    ...
    <div class="form-control">
      <div>
        <input id="confirm-terms" name="confirm-terms" type="checkbox" v-model="confirmTerms" />
        <label for="confirm-terms">I Agree the terms and conditions</label>
      </div>
    </div>
    <div>
